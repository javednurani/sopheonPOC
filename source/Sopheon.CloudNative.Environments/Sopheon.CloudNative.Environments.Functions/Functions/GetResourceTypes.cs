...
namespace Sopheon.CloudNative.Environments.Functions
{
   public class GetResourceTypes
   {
      ...
      public GetResourceTypes(EnvironmentContext context, IMapper mapper, HttpResponseDataBuilder responseBuilder)
      {
         _context = context;
         _mapper = mapper;
      ...
      [Function(nameof(GetResourceTypes))]
      [OpenApiOperation(operationId: nameof(GetResourceTypes),
         tags: new[] { "Resources" },
      ...
      {
         ILogger logger = context.GetLogger(nameof(GetResourceTypes));
         try
         {
