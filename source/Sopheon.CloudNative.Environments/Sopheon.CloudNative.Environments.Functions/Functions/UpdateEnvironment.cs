          ...
          FunctionContext context, Guid environmentKey)
      {
         ...
         try
         {
            ...
            if (!validationResult.IsValid)
            {
               ...
               return await _responseBuilder.BuildWithErrorBodyAsync(req, new ErrorDto((int)HttpStatusCode.BadRequest, validationFailureMessage));
            }
         ...
         catch (JsonException ex)
         {
            ...
            return await _responseBuilder.BuildWithErrorBodyAsync(req, new ErrorDto((int)HttpStatusCode.BadRequest, StringConstants.RESPONSE_REQUEST_BODY_INVALID));
         }
