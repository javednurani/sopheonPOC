...
dotnet ef migrations script -p "Sopheon.CloudNative.Environments.Data\Sopheon.CloudNative.Environments.Data.csproj" -o "$($env:Build_ArtifactStagingDirectory)\scripts.sql" -i -- --connectionstring "Server=.;Database=TenantBlankEnv;Integrated Security=true;"
Check-LastExitCode;
