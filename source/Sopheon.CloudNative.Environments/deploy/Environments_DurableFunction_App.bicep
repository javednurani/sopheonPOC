...
param functionAppName string = '^EnvironmentsFunctionAppNamed^'

param appInsightsName string = '^AppInsightsNamed^'

param storageAccountName string = '^EnvironmentFunctionStorageAccountNamed^'

param webServerFarm_Name string = '^WebServerFarmNamed^'
