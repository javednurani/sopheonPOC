...
$CDNHostName = az cdn endpoint show --name $ResourceGroupValue --profile-name $CDNProfileEndpointNameValue --resource-group $ResourceGroupValue --query "hostName" --output tsv;
