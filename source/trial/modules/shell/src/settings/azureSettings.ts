...
// TODO, some rawSettings are not assigned per environment (eg, AD_B2C_Sopheon_Mode_Login), can we consolidate/ eliminate pass through?
...
const azureRawSettings: Record<string, string> = {
  ...
  AD_B2C_Sopheon_Mode_Login: 'login',
  AD_B2C_Sopheon_Mode_Signup: 'signup',
};
...
export const azureSettings: Record<string, string> = {
  ...
  AD_B2C_Sopheon_Mode_Login: azureRawSettings.AD_B2C_Sopheon_Mode_Login,
  AD_B2C_Sopheon_Mode_Signup: azureRawSettings.AD_B2C_Sopheon_Mode_Signup,
};
