...
$StaticWebsiteEnabled = az storage blob service-properties update --account-name $StorageAccountNameValue --static-website --404-document TermsOfService/index.html --index-document TermsOfService/index.html --auth-mode login --query "staticWebsite.enabled";
